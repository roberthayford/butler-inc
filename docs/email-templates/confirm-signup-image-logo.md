# Confirm Signup - Image Logo Version

Supabase Auth email template for account confirmation. Uses an image-based logo.

**Supabase location:** Authentication > Email Templates > Confirm signup

> **Before using:** Replace `https://yourdomain.com/images/butlers-inc-logo.png` with the actual public URL of your hosted logo image.
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 480px;">
          ...
          <tr>
            <td align="center" style="padding-bottom: 32px;">
              <img
                src="https://yourdomain.com/images/butlers-inc-logo.png"
                alt="Butlers Inc."
                width="180"
                ...
                <tr>
                  <td align="center" style="padding-bottom: 32px;">
                    <p style="margin: 0; font-family: 'Inter', 'Helvetica Neue', Arial, sans-serif; font-size: 15px; line-height: 1.6; color: #6B7280;">
                      Welcome to Butlers Inc. Please confirm your email address to activate your account.
                    </p>
                  </td>
                </tr>
