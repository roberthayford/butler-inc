  ...
  return (
    ...
    >
      <Text style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif", fontSize: "15px", color: "#4A5568", lineHeight: "1.6", margin: "0 0 12px" }}>
        {`Hello ${first}, your ${tierName} membership renewed today. £${monthlyPrice} was charged to the card on file. Your ${hoursTotal} personal butler hours and ${tasksTotal} Virtual Butler tasks are refreshed for the new period (ends ${periodEnd}).`}
      </Text>
    </MembershipEmailLayout>
  );
}
